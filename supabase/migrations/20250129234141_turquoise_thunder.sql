/*
  # Fix Database Relationships with Auth Schema
  
  1. Tables
    - Recreates tables with proper auth.users relationships
    - Ensures foreign keys reference auth schema correctly
  
  2. Policies
    - Sets up RLS policies for secure access
    - Handles auth.users permissions properly
...
-- Create tables with proper relationships to auth.users
CREATE TABLE posts (
